  ...
  return (
    ...
    >
        ...
        <FlatList
          data={
            !isLoadingUserFollowedStreams
              ? userFollowedStreams
              : [{ id: '1' } as UserFollowedStreamsFormatted, { id: '2' } as UserFollowedStreamsFormatted]
          }
      ...
      <TopGames>
        ...
        <FlatList
          data={
            !isLoadingTopGames ? topGames : [{ id: '1' } as TopGames, { id: '2' } as TopGames, { id: '3' } as TopGames]
          }
          keyExtractor={(item) => item.id}
          horizontal
          showsHorizontalScrollIndicator={false}
          ...
          renderItem={({ item }) => (
            <TopGamesCard key={item.id} url={item.box_art_url} name={item.name} isLoadingTopGames={isLoadingTopGames} />
          )}
        />
      </TopGames>
